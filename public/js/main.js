(() => {
  ...
  var require_util = __commonJS({
    "node_modules/bootstrap/js/dist/util/index.js"(exports, module) {
      (function(global, factory) {
        ...
        exports2.defineJQueryPlugin = defineJQueryPlugin2;
        exports2.execute = execute2;
        exports2.executeAfterTransition = executeAfterTransition2;
        exports2.findShadowRoot = findShadowRoot2;
        exports2.getElement = getElement2;
        exports2.getNextActiveElement = getNextActiveElement2;
        exports2.getTransitionDurationFromElement = getTransitionDurationFromElement2;
        exports2.getUID = getUID2;
        exports2.getjQuery = getjQuery2;
        exports2.isDisabled = isDisabled2;
        exports2.isElement = isElement3;
        exports2.isRTL = isRTL2;
        exports2.isVisible = isVisible2;
        exports2.noop = noop2;
        exports2.onDOMContentLoaded = onDOMContentLoaded2;
        exports2.parseSelector = parseSelector2;
        exports2.reflow = reflow2;
        exports2.toType = toType2;
        exports2.triggerTransitionEnd = triggerTransitionEnd2;
  ...
  var require_event_handler = __commonJS({
    "node_modules/bootstrap/js/dist/dom/event-handler.js"(exports, module) {
      (function(global, factory) {
        ...
        function bootstrapHandler2(element, fn2) {
          return function handler(event) {
            hydrateObj2(event, {
              delegateTarget: element
            });
            if (handler.oneOff) {
              EventHandler2.off(element, event.type, fn2);
            }
            return fn2.apply(element, [event]);
          };
        }
        function bootstrapDelegationHandler2(element, selector, fn2) {
          return function handler(event) {
            ...
            for (let {
              ...
              for (const domElement of domElements) {
                ...
                if (handler.oneOff) {
                  EventHandler2.off(element, event.type, selector, fn2);
                }
        ...
        function addHandler2(element, originalTypeEvent, handler, delegationFunction, oneOff) {
          ...
          const fn2 = isDelegated ? bootstrapDelegationHandler2(element, handler, callable) : bootstrapHandler2(element, callable);
        ...
        function removeHandler2(element, events, typeEvent, handler, delegationSelector) {
          const fn2 = findHandler2(events[typeEvent], handler, delegationSelector);
          if (!fn2) {
            return;
          }
  ...
  var require_config = __commonJS({
    "node_modules/bootstrap/js/dist/util/config.js"(exports, module) {
      ...
      })(exports, function(Manipulator2, index_js) {
        "use strict";
        class Config2 {
          // Getters
          static get Default() {
  ...
  var require_base_component = __commonJS({
    "node_modules/bootstrap/js/dist/base-component.js"(exports, module) {
      ...
      })(exports, function(Data2, EventHandler2, Config2, index_js) {
        "use strict";
  ...
  var require_component_functions = __commonJS({
    "node_modules/bootstrap/js/dist/util/component-functions.js"(exports, module) {
      (function(global, factory) {
      ...
      })(exports, function(exports2, EventHandler2, SelectorEngine2, index_js) {
        "use strict";
        const enableDismissTrigger2 = (component, method = "hide") => {
          ...
          EventHandler2.on(document, clickEvent, `[data-bs-dismiss="${name}"]`, function(event) {
            ...
            const target = SelectorEngine2.getElementFromSelector(this) || this.closest(`.${name}`);
            const instance = component.getOrCreateInstance(target);
            instance[method]();
          });
        };
        exports2.enableDismissTrigger = enableDismissTrigger2;
        Object.defineProperty(exports2, Symbol.toStringTag, { value: "Module" });
      });
    }
  });
  ...
  var require_alert = __commonJS({
    "node_modules/bootstrap/js/dist/alert.js"(exports, module) {
      (function(global, factory) {
      ...
      })(exports, function(BaseComponent2, EventHandler2, componentFunctions_js, index_js) {
        "use strict";
        const NAME2 = "alert";
        const DATA_KEY2 = "bs.alert";
        const EVENT_KEY2 = `.${DATA_KEY2}`;
        const EVENT_CLOSE2 = `close${EVENT_KEY2}`;
        const EVENT_CLOSED2 = `closed${EVENT_KEY2}`;
        const CLASS_NAME_FADE2 = "fade";
        const CLASS_NAME_SHOW2 = "show";
        class Alert3 extends BaseComponent2 {
          // Getters
          static get NAME() {
            return NAME2;
          }
          ...
          close() {
            ...
            const isAnimated = this._element.classList.contains(CLASS_NAME_FADE2);
          ...
          static jQueryInterface(config) {
            return this.each(function() {
              const data = Alert3.getOrCreateInstance(this);
        ...
        componentFunctions_js.enableDismissTrigger(Alert3, "close");
        index_js.defineJQueryPlugin(Alert3);
        return Alert3;
      });
    }
  });
